    ...
    DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
        ...
        var html = '' +
            ...
            (isDateValid ?
                ...
                innerHtml) +
            '</th>';
			var dayHeaderBuilder = this.opt('dayHeaderBuilder');
			if(dayHeaderBuilder) html = dayHeaderBuilder(date, html, view);
			return html;
    };
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
        ...
        if (isDayNumberVisible) {
           ...
           var dayNumberBuilder = this.opt('dayNumberBuilder');
		   	  if(dayNumberBuilder) html = dayNumberBuilder(date, html, view);
        }
        html += '</td>';
        return html;
    };
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName == 'title') {
                        ...
                        if (buttonClick) {
                            ...
                            var buttonHtml;
                            if(_this.calendar.optionsManager.overrides.buttonHtmls)
                                buttonHtml = _this.calendar.optionsManager.overrides.buttonHtmls[buttonName];
                            if(!buttonHtml || buttonHtml=='') {
                                ...
                                buttonHtml = '<button type="button" class="' + buttonClasses.join(' ') + '">' + buttonInnerHtml + '</button>';
                            }
